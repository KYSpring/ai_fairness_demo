...
// Mock Part III: Imbalanced Inaccuracy Analysis 数据
...
<div class="upload-content">
  ...
  <t-form v-if="uploadMode === 'auto'" :data="formData" :rules="rules" class="form-content">
    ...
    <t-form-item label="Temperature">
      <t-input v-model="formData.temperature" placeholder="Enter Model Temperature" />
    </t-form-item>
...
>
  ...
  <!-- Part III: Imbalanced Inaccuracy Analysis -->
  <div class="analysis-section">
