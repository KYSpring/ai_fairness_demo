...
OPENROUTER_API_KEY = "yourAPIkey"  # Replace with your actual API key
MODEL_NAME = "deepseek/deepseek-r1:free"  # OpenRouter DeepSeek model
...
current_dir = os.path.dirname(os.path.abspath(__file__))
input_dir = os.path.join(current_dir, "v3", "dateset_for_experiment/")
output_dir = os.path.join(current_dir, "output_for_experiment/")
os.makedirs(output_dir, exist_ok=True)
input_files = glob.glob(os.path.join(input_dir, '*_changed.json'))

start_file = input_dir + r"victim_age_changed.json"
